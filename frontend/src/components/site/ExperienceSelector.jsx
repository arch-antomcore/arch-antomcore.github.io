...
const COPY = {
  pt: {
    ...
    lightDescription: "Conteúdo completo com rolagem suave e animações discretas, sem 3D/WebGL nem vídeo automático.",
  ...
  en: {
    ...
    lightDescription: "The complete content with smooth scrolling and subtle motion, no 3D/WebGL, and no autoplay video.",
