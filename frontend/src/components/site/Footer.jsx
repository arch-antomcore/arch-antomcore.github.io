...
const Footer = () => {
  ...
  // Bugfix: Handle smooth scrolling to internal hash anchors (e.g. #seguranca) on route changes
  useEffect(() => {
    if (location.hash) {
  ...
  return (
    ...
    >
      <footer
        ...
        data-cursor="hidden"
      >
        {/* Aceternity Interactive Background Boxes */}
        ...
        >
          <div className="footer-glass-surface w-full border border-[#211d18]/10 shadow-2xl pointer-events-none relative overflow-hidden rounded-[24px]">
          ...
          <div className="flex flex-col items-center justify-between gap-6 pt-6 md:flex-row">
            {/* Copyright */}
            <p className="text-xs text-[#211d18]/50 font-mono tracking-tight text-center md:text-left pointer-events-auto">
              {BRAND.copyright}
            </p>

            {/* Controls (Switcher & Version) */}
            ...
            <Magnetic strength={0.28}>
              <button
                ...
                className="group flex h-9 w-9 items-center justify-center rounded-full border border-[#211d18]/10 bg-[#ece7da] hover:bg-[#f4f1e8] hover:border-[#211d18]/20 text-[#211d18]/60 hover:text-[#211d18] transition-all duration-200 pointer-events-auto"
              >
                <ArrowUp
