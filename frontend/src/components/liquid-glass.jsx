...
export const GlassEffect = ({
  ...
  const glassStyle = {
    boxShadow: "0 6px 18px rgba(33, 29, 24, 0.08), 0 0 20px rgba(33, 29, 24, 0.04)",
  ...
  const content = (
    <div
      ...
      {/* Glass Layers */}
      <div
        className="absolute inset-0 z-0 overflow-hidden backdrop-blur-2xl"
        style={{
      ...
      <div
        ...
        style={{
          boxShadow:
            "inset 1px 1px 1px 0 rgba(255, 255, 255, 0.7), inset -1px -1px 1px 1px rgba(33, 29, 24, 0.08)",
        }} />
