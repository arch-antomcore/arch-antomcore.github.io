...
export function AnimatedGeometricCard({ className, ...props }) {
  return (
    <div
      role="region"
...
const BackgroundGradient = ({ primaryColor, accentColor, particleColor }) => {
  return (
...
const StatusIndicators = ({ primaryColor, accentColor }) => {
  return (
...
const FloatingElements = ({ hovered, primaryColor }) => {
  return (
...
const GeometricShapes = ({ hovered, primaryColor, accentColor, particleColor }) => {
  const shapes = [
  ...
  const getShapeColor = (colorVariant, index) => {
    switch (colorVariant) {
...
const ParticleLayer = ({ hovered, mounted, primaryColor, accentColor, particleColor }) => {
  ...
  const getParticleColor = (colorType) => {
    switch (colorType) {
...
const ColorOverlay = ({ primaryColor, accentColor, particleColor }) => {
  return (
